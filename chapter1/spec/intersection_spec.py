...
sys.path.append('/cygdrive/d/github/computation/chapter1')
...
class TestAutomata(unittest.TestCase):
    ...
    def test_intersection(self):
        ...
        print inter_auto._get_states()
        print inter_auto._get_sigma()
        print inter_auto._get_ttable()
        print inter_auto._get_final()
